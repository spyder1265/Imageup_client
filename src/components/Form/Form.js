        ...
        <form onSubmit={handleSubmit}>
          ...
          {!isLogin && (
            <div className='flex w-full mb-4 gap-2'>
              <input
                ...
                className='form-email focus:border-0 rounded h-10'
              />
            </div>
          )}
          <div className='flex w-full mb-6 gap-2'>
            <input
              ...
              placeholder='*********'
              className='form-password focus:border-0 rounded h-10'
            />
          </div>
          ...
          <div className='flex w-full p-2 flex-col mb-4 border-t border-black justify-center '>
            <button
              type='button'
              className='py-2 text-[13px] h-8 text-indigo-500 hover:underline '
            ...
            {isLogin && (
              <Link
                to='/Form/PasswordReset'
                className='py-2 text-[11px] text-center h-8 text-indigo-500 hover:underline '
              >
                {" "}
